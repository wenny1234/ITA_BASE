...
public class WeldMockSample {
	...
	public void test_normal1() {
		 ...
		 * Mockito.when(cXXDA01644Mapper.find(cap.capture())).thenAnswer(new
		 * Answer<Object>() { public Object answer(InvocationOnMock invocation)
		 * throws Throwable { return ((CXXDA01644Mapper)
		 * wmu.useInject(cXXDA01644Mapper)) .find((CXXDA01644InDaoDTO)
